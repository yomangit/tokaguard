    ...
    <x-tabs-cause-analysis.layout>
        ...
        <div class="tooltip tooltip-right ">
            <div class="tooltip-content ">
                <div class="animate-bounce text-orange-400 text-sm font-black">Tambah KTA</div>
            </div>
        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-base-100 rounded-lg shadow-lg w-full max-w-md p-4">
                <h3 class="font-bold text-md mb-3">{{ $ktaId ? 'Edit KTA' : 'Tambah KTA' }} </h3>
