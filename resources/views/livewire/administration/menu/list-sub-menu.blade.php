                    ...
                    <tr>
                        ...
                        <th class='flex justify-center flex-row gap-2'>
                            <flux:tooltip content="edit" position="top">
                                <flux:button wire:click="open_modal({{ $menu->id }})" size="xs" icon="pencil-square" variant="subtle"></flux:button>
                            </flux:tooltip>
        ...
        <flux:modal name="sub-menu">
            <form wire:submit='store' class='grid justify-items-stretch'>
                ...
                <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-xs sm:w-sm border p-2 sm:justify-self-center">
                    ...
                    {{-- Parent Menu --}}
                    <x-label-req>{{ __('Menu Utama') }} </x-label-req>
                    <flux:select size="xs" wire:model.live="menu_id" placeholder="Choose Status...">
                    ...
                    {{-- Route --}}
                    <x-label-no-req>{{ __('route') }} </x-label-no-req>
                    ...
                    {{--Request Route --}}
                    <x-label-no-req>{{ __('Request Route') }} </x-label-no-req>
