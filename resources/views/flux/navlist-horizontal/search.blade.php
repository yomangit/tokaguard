...
->add('h-10 lg:h-8 relative flex items-center gap-3 outline-none ')
->add($square ? 'px-2.5!' : '')
...
'hover:text-zinc-800 dark:hover:text-accent-content  ',
...
'hover:text-zinc-800 dark:hover:text-accent-content  dark:hover:bg-white/10',
],
},
})
;
