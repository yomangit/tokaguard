...
->add('h-10 lg:h-6 relative flex items-center gap-3 outline-none ')
->add($square ? 'px-2.5!' : '')
->add('py-0 text-center w-full px-3 my-px')
...
'data-current:bg-white dark:data-current:bg-neutral data-current:border data-current:border-zinc-200 dark:data-current:border-4-accent',
...
true => [
'data-current:text-primary hover:data-current:text-primary',
'data-current:bg-zinc-800/[4%] dark:data-current:bg-transparent ',
'border-b-2 hover:border-b-accent hover:border-b-2 data-current:border-b-2 data-current:border-b-primary',
'hover:text-zinc-800 ' ,
],
false => [
