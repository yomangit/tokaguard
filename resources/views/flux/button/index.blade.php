...
'primary' => 'bg-[var(--color-success)] hover:bg-[color-mix(in_oklab,_var(--color-success),_transparent_30%)]',
'accent' => 'bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_30%)]',
...
'danger' => 'bg-[var(--color-error)] hover:bg-[color-mix(in_oklab,_var(--color-error),_transparent_30%)]',
'ghost' => 'bg-transparent hover:bg-zinc-800/5 dark:hover:bg-white/15',
'subtle' => 'bg-[var(--color-warning)] hover:bg-[color-mix(in_oklab,_var(--color-warning),_transparent_30%)]',

})
->add(match ($variant) { // Text color...
'primary' => 'text-[var(--color-primary-content)]',
'accent' => 'text-[var(--color-accent-content)]',
'filled' => 'text-zinc-800 dark:text-primary-content',
'outline' => 'text-zinc-800 dark:text-primary-content',
'danger' => 'text-primary-content',
'ghost' => 'text-zinc-800 dark:text-base-content',
'subtle' => 'text-[var(--color-base-content)] hover:text-zinc-800 dark:text-[var(--color-primary-content)] dark:hover:text-white',

})
->add(match ($variant) { // Border color...
'primary' => 'border border-black/10 dark:border-0',
'accent' => 'border border-black/10 dark:border-0',
...
'accent' => '[[data-flux-button-group]_&]:border-e-0 [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-[1px] dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-0 dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-s-[1px] [:is([data-flux-button-group]>&:not(:first-child),_[data-flux-button-group]_:not(:first-child)>&)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)]',
})
