...
'data-current:bg-white dark:data-current:bg-neutral/[30%] dark:data-current:border-neutral dark:data-current:border-l-4 data-current:border data-current:border-zinc-200 dark:data-current:border-transparent',
...
'data-current:bg-zinc-800/[4%] dark:data-current:bg-neutral/[30%] dark:data-current:border-neutral dark:data-current:border-l-4',
